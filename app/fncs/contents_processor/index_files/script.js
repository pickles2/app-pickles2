					...
					$btn
						.on('click', function(){
							...
							pathLogFileName = (function(){
								...
								filename += px.utils79.str_pad(date.getFullYear(), 4, '0', 'left');
								filename += px.utils79.str_pad((date.getMonth()+1), 2, '0', 'left');
								filename += px.utils79.str_pad(date.getDate(), 2, '0', 'left');
								filename += '-';
								filename += px.utils79.str_pad(date.getHours(), 2, '0', 'left');
								filename += px.utils79.str_pad(date.getMinutes(), 2, '0', 'left');
								filename += px.utils79.str_pad(date.getSeconds(), 2, '0', 'left');
								filename2 = '';
								var i = 0;
...
},{"../../../fncs/contents_processor/index_files/libs.ignore/processor.js":1}]},{},[2])